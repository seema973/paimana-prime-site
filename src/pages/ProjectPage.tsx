...
const projectsData: Record<string, ProjectData> = {
  'nie-i-state': {
    id: 'nie-i-state',
    name: 'NIE-I',
    fullName: 'National Infrastructure Enablement Index - State/UTs (NIE-I)',
    description: 'National Infrastructure Enablement Index (NIE-I (State/UTs)) is an initiative under the Government of India\'s PAIMANA platform, designed to monitor and assess infrastructure enablement and development indicators at the state level.',
    logo: '/niei-logo.jpg',
    color: 'blue',
